<%@ Page Title="SIAN - Sistema de Control de Inventarios" Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true" CodeFile="notas_credito.aspx.cs" Inherits="facturas_notas_credito" %>
    ...
    <table border="0" cellspacing="0" cellpadding="0" style="width: 900px;">
        <tr>
            <td class="HeaderTitulos" colspan="3" style="height: 18px;">
                &emsp;Notas de Crédito - Listado de Datos</td>
        </tr>
        <tr>
            <td style="width: 569px;  height: 20px;" align="left" class="Cellformat1">
                ...
                <asp:DropDownList ID="dlBusqueda" runat="server" CssClass="SelectFormat">
                    ...
                    <asp:ListItem Text="Devueltas parcial" Value="6"></asp:ListItem>
                </asp:DropDownList>&nbsp;
            ...
            <td align="left">
                <asp:LinkButton ID="lblAgregar" runat="server" CssClass="LinkFormat"
                    onclick="lblAgregar_Click">Generar Nota de Crédito</asp:LinkButton></td>
        </tr>
        <tr>
...
<Columns>
    <asp:BoundField DataField="referencia" HeaderText="Factura/Remisión/Nota de Cargo">
        <HeaderStyle Width="100px" />
        <ItemStyle HorizontalAlign="Left" />
    </asp:BoundField>
...
<td class="Cellformat1" align="right">Pagos hechos:
<asp:LinkButton ID="lnkPagos" runat="server" CssClass="LinkFormat"
onclick="lnkPagos_Click" />
</td>
</tr>
<tr>
<td class="Cellformat1" align="left" style="width:150px;">Nota de Crédito:</td>
...
<asp:Button ID="btnFactura" runat="server" Text="Usar factura"
        CssClass="ButtonFormat" onclick="btnFactura_Click" />
</td>
</tr>
<tr>
<td align="center" colspan="4">
...
<Columns>
    ...
    <asp:BoundField DataField="devuelto" HeaderText="Cantidad Devuelta">
        <HeaderStyle Width="70px" />
        <ItemStyle HorizontalAlign="Right" />
    </asp:BoundField>
</Columns>
...
<cc1:ModalPopupExtender ID="mdCorreo" runat="server"
    ...
    DropShadow="False" />
<asp:Panel ID="pnlEntrada" Visible="false" runat="server" DefaultButton="btnDevolver">
<table border="0" cellspacing="0" cellpadding="0" style="width: 800px;">
<tr><td class="GridFormat" style="height: 18px;">
   Devolución a almacén</td>
</tr>
<tr style="height:10px">
<td></td>
</tr>
...
<asp:GridView ID="gvProductosAlmacen" runat="server" SkinID="grdSIAN"
    Height="1px" SelectedIndex="0" Width="800px" AllowSorting="True"
        CellPadding="0"  AutoGenerateColumns="false" DataKeyNames="productoID"
    HorizontalAlign="Left" EnableViewState="True"
    EnableTheming="True" UseAccessibleHeader="True" CaptionAlign="Top" GridLines="None"
...
<Columns>
    ...
    <asp:TemplateField HeaderText="Cantidad a devolver">
        <HeaderStyle Width="100px" />
        <ItemStyle HorizontalAlign="Right" />
        <ItemTemplate>
        <asp:TextBox ID="txtCantidad" runat="server" CssClass="TextInputFormatD" MaxLength="5" Width="100px"></asp:TextBox>
        </ItemTemplate>
    </asp:TemplateField>
    <asp:TemplateField HeaderText="<%$ Resources: sian, lblLote %>">
        <HeaderStyle Width="100px" />
        <ItemStyle HorizontalAlign="Right" />
        <ItemTemplate>
        <asp:TextBox ID="txtLote" runat="server" CssClass="TextInputFormat" MaxLength="20" Width="100px"></asp:TextBox>
        </ItemTemplate>
    </asp:TemplateField>
...
<tr>
<td align="center">
<asp:Button ID="btnDevolver" runat="server" Text="Devolver productos"
        CssClass="ButtonFormat" onclick="btnDevolver_Click" />
</td>
</tr>
</table>
</asp:Panel>
...
<div>
    ...
    <asp:Label ID="Label16" runat="server" CssClass="msgError1">La nota de crédito no pudo ser cancelada automáticamente, pero puede cancelarse manualmente a través del sitio del SAT</asp:Label><br /><br />
...
<cc1:ModalPopupExtender ID="mdCancelarWS" runat="server"
    ...
    DropShadow="False" />
<asp:Panel ID="pnlFacturaListado" Visible="false" runat="server">
<table border="0" cellspacing="0" cellpadding="0" style="width: 800px;">
<tr><td class="GridFormat" style="height: 18px;">
    Factura</td>
</tr>
...
<tr>
    <td class="Cellformat1" align="center">Ingrese el número de la factura:
        <asp:TextBox ID="txtFacturaID" runat="server" MaxLength="6" CssClass="TextInputFormatD" Width="60px" ></asp:TextBox>
        <asp:Button ID="btnBuscarFactura" runat="server" Text="Continuar" CssClass="ButtonFormat" onclick="btnBuscarFactura_Click" />
    </td>
</tr>
<tr>
    <td class="Cellformat1" align="center">
        <asp:Button ID="btnRegresarListaFactura" runat="server" Text="Regresar" CssClass="ButtonFormat" onclick="btnRegresarListaFactura_Click" />
    </td>
</tr>
</table>
</asp:Panel>
<asp:Panel ID="pnlFactura" Visible="false" runat="server">
<table border="0" cellspacing="0" cellpadding="0" style="width: 800px;">
...
<tr>
<td style="width:100px;" class="Cellformat1" align="left">Factura:</td>
...
<td align="center" colspan="4">
    <asp:Panel runat="server" ID="Panel1" Width="800">
        <table>
            <tr class="GridFormat">
                <td style="width:500px;color:white;font-size:XX-Small;"><asp:Label ID="Label5" runat="server">Producto</asp:Label>
                </td>
                <td style="width:80px;color:white;font-size:XX-Small;"><asp:Label ID="Label34" runat="server">Cantidad</asp:Label>
                </td>
                <td style="width:120px;color:white;font-size:XX-Small;"><asp:Label ID="Label8" runat="server">Precio</asp:Label>
                </td>
                <td style="width:100px;color:white;font-size:XX-Small;"><asp:Label ID="Label11" runat="server">Subtotal</asp:Label>
                </td>
            </tr>
        </table>
    </asp:Panel>
    <asp:GridView ID="gvProductosFactura" runat="server" AutoGenerateColumns="false"
        CaptionAlign="Top" CellPadding="0" DataKeyNames="productoID" Width="800"
        EnableViewState="True" GridLines="None" Height="1px" ShowHeader="false" OnRowDataBound="gvProductosFactura_RowDataBound"
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:Panel runat="server" ID="pnlDatos" Width="800">
                        <table>
                            <tr>
                                <td style="width:500px"><asp:Label runat="server" ID="lblProd" Text='<%# DataBinder.Eval(Container.DataItem, "producto") %>' />
                                </td>
                                <td style="width:80px" align="center"><asp:TextBox ID="txtCantidadFactura" runat="server" CssClass="TextInputFormatD"
                                ...
                                <td style="width:120px" align="left"><asp:TextBox ID="txtCostoUnitarioFactura" runat="server" CssClass="TextInputFormatD"
    ...
    <asp:Button ID="btnRegresarFactura" runat="server" Text="Regresar"
        CssClass="ButtonFormat" onclick="btnRegresarListaFactura_Click" />
</td>
</tr>
</table>
</asp:Panel>
<script type="text/javascript">
    ...
    function seleccionar(valor) {
        var gv = $get('<%=gvProductosFactura.ClientID%>');

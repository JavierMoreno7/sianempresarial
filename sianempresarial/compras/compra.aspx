...
<asp:TextBox ID="txtLote" runat="server" MaxLength="35" Width="85px" CssClass="TextInputFormat" ></asp:TextBox>
</td>
...
<div>
    ...
    <tr><td align="right" class="Cellformat1"><asp:Label ID="Label101" runat="server" Text="<%$ Resources: sian, lblLote %>" />:</td>
        <td align="left" class="Cellformat1">
        <asp:TextBox ID="txtCambiarLote" runat="server" MaxLength="35" Width="150px" CssClass="TextInputFormat" ></asp:TextBox>
    </td></tr>
...
<table border="0" cellspacing="0" cellpadding="0" style="width: 940px;">
<tr style="height:10px">
<td colspan="4"></td>
</tr>
<tr>
...
<tr>
<td align="center" colspan="4">
    <asp:Panel runat="server" ID="Panel2" Width="940">
        <table>
            <tr class="GridFormat">
		        ...
		        <td style="width:100px;color:white;font-size:XX-Small;"><asp:Label ID="Label16" runat="server">Precio</asp:Label>
                </td>
                <td style="width:110px;color:white;font-size:XX-Small;"><asp:Label ID="Label17" runat="server" Text="<%$ Resources: sian, lblLote %>"></asp:Label>
                </td>
    ...
    <asp:GridView ID="gvProductosCompra" runat="server" AutoGenerateColumns="false"
        CaptionAlign="Top" CellPadding="0" DataKeyNames="productoID" Width="940"
        EnableViewState="True" GridLines="None" Height="1px" ShowHeader="false"
        HorizontalAlign="Center" SelectedIndex="0" SkinID="grdSIAN"
        ...
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:Panel runat="server" ID="pnlDatos" Width="940">
                        <table>
                            <tr>
                                ...
                                <td style="width:50px;" align="left"><asp:Label ID="lblCantDatos" runat="server" CssClass="Cellformat1"
                                ...
                                <td style="width:70px;" align="center"><asp:TextBox ID="txtCantidadDatos" runat="server" CssClass="TextInputFormatD"
                                        Text='<%# DataBinder.Eval(Container.DataItem, "cantidad") %>' MaxLength="8" Width="30px"></asp:TextBox>
                                </td>
                                <td style="width:100px;" align="left"><asp:TextBox ID="txtCostoDatos" runat="server" CssClass="TextInputFormatD" Enabled='<%# DataBinder.Eval(Container.DataItem, "enabled") %>'
                                ...
                                <td style="width:100px;" align="right"><asp:TextBox ID="txtLoteDatos" runat="server" CssClass="TextInputFormat"
                                        Text="" MaxLength="35" Width="80px"></asp:TextBox>
                                </td>
                                <td style="width:120px;" align="right"><asp:Textbox id="txtFechaDatos" runat="server" Width="90px" CssClass="datePicker" Text=""></asp:Textbox>
                                </td>
